...
/**
 * hMailserver remote forwarding changer
 *
 * @version 1.0
...
try {
	...
	switch($action){
		...
		case 'forwarding_save':
			$obAccount->ForwardEnabled      = isset($_POST['enabled']) ?: 0;
			$obAccount->ForwardAddress      = $_POST['address'];
			$obAccount->ForwardKeepOriginal = isset($_POST['keeporiginal']) ?: 0;
			$obAccount->Save();
